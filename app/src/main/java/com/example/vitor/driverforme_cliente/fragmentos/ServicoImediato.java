 ...
 */
public class ServicoImediato extends Fragment {
    ...
    private DatabaseReference servicosAbertos = FirebaseEstatico.getFirebase().child("servicosImediatosAbertos");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_servico_imediato, container, false);
